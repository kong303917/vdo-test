<template>
    <div style="position: relative;">
        ...
        <div class="image-wrap" :style="'background-image: url(' + movie.images.large + ')'"></div>
        ...
        <div class="star">
            ...
            <mu-icon class="star-icon" :size="36" value="star_left" v-for="n in ratingStar(movie.rating.average).left" />
        </div>
        <div class="info">
