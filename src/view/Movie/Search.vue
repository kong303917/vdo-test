<template>
    <div id="search">
        <mu-pager class="demo-pager" :zDepth="1">
                    ...
                    <div class="text">
                        ...
                        <div class="star">
                            <span class="star-box" v-if="subject.rating.average > 0">
                                ...
                                <mu-icon class="star-icon" :size="14" value="star_left" v-for="n in ratingStar(subject.rating.average).left" />
                            </span>
